...
bodies = list()
players = list()
bodies.append(Body((int(screen_dims[0] / 2 + 300), int(screen_dims[1] / 2)), θ=None, m=160, r=40, body_type="star", threat_to=("player", "pellet", "shrapnel", "bullet", "static"), damage=5))
bodies.append(Body((int(screen_dims[0] / 2 - 300), int(screen_dims[1] / 2)), θ=None, m=160, r=40, body_type="star", threat_to=("player", "pellet", "shrapnel", "bullet", "static"), damage=5))
player1 = Body((200, 200), r=10, friction=(1 / 400, 5), body_type="player", shot_type="shotgun",
               update_type=1, threat_to=("pellet", "shrapnel", "bullet", "static"), damage=5, threatened_by=("pellet", "shrapnel", "bullet", "static", "star"), health=5, self_destruct={"s": True},
               player_controls=((pygame.K_w, 250), (pygame.K_a, -30), (pygame.K_s, -50), (pygame.K_d, 30), (pygame.K_LSHIFT, 300), pygame.K_r))
player2 = Body((screen_dims[0] - 200, screen_dims[1] - 200), r=10, friction=(1 / 400, 5), body_type="player", shot_type="gun",
               update_type=1, threat_to=("pellet", "shrapnel", "bullet", "static"), damage=5, threatened_by=("pellet", "shrapnel", "bullet", "static", "star"), health=5, self_destruct={"s": True},
               player_controls=((pygame.K_UP, 250), (pygame.K_LEFT, -30), (pygame.K_DOWN, 50), (pygame.K_RIGHT, 30), (pygame.K_RCTRL, 300), pygame.K_RETURN))
player3 = Body((screen_dims[0] - 200, 200), r=10, friction=(1 / 400, 5), body_type="player", shot_type="sniper",
               update_type=1, threat_to=("pellet", "shrapnel", "bullet", "static"), damage=5, threatened_by=("pellet", "shrapnel", "bullet", "static", "star"), health=5, self_destruct={"s": True},
               player_controls=((pygame.K_i, 250), (pygame.K_j, -30), (pygame.K_k, 50), (pygame.K_l, 30), (pygame.K_n, 300), pygame.K_p))
player4 = Body((200, screen_dims[1] - 200), r=10, friction=(1 / 400, 5), body_type="player", shot_type="science",
               update_type=1, threat_to=("pellet", "shrapnel", "bullet", "static"), damage=5, threatened_by=("pellet", "shrapnel", "bullet", "static", "star"), health=5, self_destruct={"s": True},
...
while not done:
    ...
    for player in players:
        if player in bodies:
            ...
            if keys[player.player_controls[5]]:
                player.default()
